...
public class ImageEdit extends Applet
{
    ...
    public ImageEdit()
    {
        ...
        japan = new  MyPanel(); //Панель для рисования 
        japan.setBounds(50,50,260,260);
        ...
        JToolBar toolbar = new  JToolBar("Toolbar", JToolBar.VERTICAL);
          ...
          JButton poligonbutton = new JButton(new  ImageIcon("lastic.png"));
          poligonbutton.addActionListener(new  ActionListener()
            {
              public void actionPerformed(ActionEvent event)
              { 
                rezhim=7;
          ...
          toolbar.setBounds(0, 0, 50, 600); //размер кнопок режима рисования
          f.add(toolbar);
          ...
          colorbutton.setBounds(15, 5, 30, 30); //размер кнопки выбора палитры
          ...
          redbutton.setBounds(50, 5, 25, 25); //размер кнопки
          ...
          orangebutton.setBounds(75, 5, 25, 25);
          ...
          yellowbutton.setBounds(100, 5, 25, 25);
          ...
          greenbutton.setBounds(125, 5, 25, 25);
          ...
          bluebutton.setBounds(150, 5, 25, 25);
          ...
          cyanbutton.setBounds(175, 5, 25, 25);
          ...
          magentabutton.setBounds(200, 5, 25, 25);
          ...
          whitebutton.setBounds(225, 5, 25, 25);
          ...
          blackbutton.setBounds(250, 5, 25, 25);
          ...
          colorbar.setBounds(50, 0, 250, 30); //размер серого тулбара
          f.add(colorbar);
                        ...
                        switch(rezhim)
                        {
                             // линия
                              ...
                              case 6:
                                  ...
                                  break;
                              case 7:
                            	  g.fillPolygon(x1, y1, (x2-x1), (y2-y1));
                        }
                        xf=0; yf=0;
                        pressed=false;
                        japan.repaint();
    ...
    class ColorDialog extends JDialog //окно палитры
    {
